...
import image_cv from "../../assets/cv_kacper_pirog_JFD_EN_web.jpg";
import image_cv_pdf from "../../assets/cv_kacper_pirog_JFD_EN_web.pdf";
...
const SliderHome = () => {
  ...
  // const openInNewTab = () => {
  //   const url = "../../assets/cv_kacper_pirog_JFD_EN_web.jpg";
  ...
  return (
    <>
        ...
        <StyledDiv>
          ...
          <div>
            <h3>
              ...
              websites that blend aesthetic beauty with functionality and ease
              of use.
            </h3>
            <BtnShowProject onClick={() => setModalIsOpen(true)}>
              <h6>Show CV</h6>
            </BtnShowProject>
          </div>
          <StyledDivCircle>
      ...
      <ModalWrapper
        ...
        contentLabel="Przykładowy popup"
        ariaHideApp={false}
      >
        <div>
          ...
          <a href={image_cv_pdf} download>
            <img src={image_cv} alt="Opis obrazu" />
          </a>
        </div>
      </ModalWrapper>
    </>
